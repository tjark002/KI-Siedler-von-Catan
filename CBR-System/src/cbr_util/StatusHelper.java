...
public class StatusHelper {
	 ...
	 * @return Der zu dem gegebenen String zugehoerige enum-Wert.
	 */
	/*public static boolean getDistanceToCoverByString(String val) {
	...
	public static boolean getCityPlacesActive(String valueAsString) {
		
		return false;
	}

	public static boolean getVillagePlacesActive(String valueAsString) {
		// TODO Auto-generated method stub
		return false;
	}

	public static boolean getRoadPlacesActive(String valueAsString) {
		// TODO Auto-generated method stub
		return false;
	}

	public static boolean getIsFirstTurn(String string) {
		// TODO Auto-generated method stub
		return false;
	}

	public static boolean getIsSecondTurn(String valueAsString) {
		// TODO Auto-generated method stub
		return false;
	}

	public static boolean getIsAllowedToRollDice(String valueAsString) {
		// TODO Auto-generated method stub
		return false;
	}

	public static boolean getIsAbledToEndTurn(String valueAsString) {
		// TODO Auto-generated method stub
		return false;
	}*/
